...
<script>
    //document.getElementById('my-script').addEventListener('load', handleReadyStateChange);
...
<script id="my-script" src="https://unpkg.com/requirejs@2.3.6/require.js" onload="handleReadyStateChange()"></script>
